...
module tb_RISCVCPU;
    ...
    task load_program_full_dependencies;
        begin
            ...
            //adicionamos 3 nops, 2 ainda não foi suficiente 
            // NOP = addi x0, x0, 0
            // 32'h00000013
            ...
            cpu.IMemory[4]  = 32'h00508113; // addi x2, x1, 5      # x2 = 15
            cpu.IMemory[5]  = 32'h00000013; // nop
            cpu.IMemory[6]  = 32'h00000013; // nop
            cpu.IMemory[7]  = 32'h00000013; // nop

            cpu.IMemory[8]  = 32'h00110193; // addi x3, x2, 1      # x3 = 16
            cpu.IMemory[9]  = 32'h00000013; // nop
            cpu.IMemory[10] = 32'h00000013; // nop
            cpu.IMemory[11] = 32'h00000013; // nop

            cpu.IMemory[12] = 32'h00302223; // sw   x3, 4(x0)      # mem[1] = 16

            // x4 também depende de x3, mas já existe distância suficiente
            // por causa dos NOPs antes do sw e do próprio sw
            cpu.IMemory[13] = 32'h00a18213; // addi x4, x3, 10     # x4 = 26

            // beq em PC = 14*4 = 56
            // label em PC = 17*4 = 68
            // offset = 12 bytes
            cpu.IMemory[14] = 32'h00420663; // beq  x4, x4, label  # sempre tomado

            cpu.IMemory[15] = 32'h06300293; // addi x5, x0, 99     # deve ser flushado
            cpu.IMemory[16] = 32'h05800313; // addi x6, x0, 88     # pode ser flushado

            // label:
            cpu.IMemory[17] = 32'h00120393; // addi x7, x4, 1      # x7 = 27

            cpu.IMemory[18] = 32'h0000000b; // halt
        end
    endtask
